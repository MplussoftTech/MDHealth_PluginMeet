...
import WebcamIcon from '../footer/icons/webcam';
import MicrophoneIcon from '../footer/icons/microphone';
  ...
  return (
    <>
      <div className={cssClasses}>
        ...
        {/* <WebcamIcon currentRoom={currentConnection.room} />
        <MicrophoneIcon currentRoom={currentConnection.room} /> */}
      </div>
